...
const Recommendations = ({ recommendations, handleListItemClick }) => {
  ...
  return (
    ...
    >
      <div className="max-h-[calc(100vh-200px)] overflow-y-auto scrollbar-thin scrollbar-thumb-[#02c39a]/20 
        scrollbar-track-transparent hover:scrollbar-thumb-[#02c39a]/40 pr-2">
